...
class TestMakeFVCOMAtmosForcing:
    ...
    config = {
        'vhfr fvcom runs': {
            ...
            'atmospheric forcing': {
                'hrdps grib dir':
                    'forcing/atmospheric/GEM2.5/GRIB/',
                'fvcom atmos dir':
                    'forcing/atmospheric/GEM2.5/vhfr-fvcom',
                'atmos file template':
                    "atmos_{run_type}_{field_type}_{yyyymmdd}.nc",
                'fvcom grid dir':
                    'nowcast-sys/FVCOM-VHFR-config/grid/',
            }
        },
    }
        ...
        expected = {
            run_type: {
                'run date':
                    '2018-03-16',
                'wnd':
                    'forcing/atmospheric/GEM2.5/vhfr-fvcom/atmos_nowcast_wnd_20180316.nc'
            }
        }
