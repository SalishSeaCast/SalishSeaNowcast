...
class TestRunWW3:
    ...
    @patch(
        'nowcast.workers.run_ww3._launch_run', return_value='bash SoGWW3.sh'
    )
    def test_checklist(
...
class TestWW3ShelContents:
    ...
    def test_ww3_shel_contents(self, run_type, end_time):
        contents = run_ww3._ww3_shel_contents(
...
class TestWW3OunfContents:
    ...
    def test_ww3_ounf_contents(self, run_type):
        contents = run_ww3._ww3_ounf_contents(
            arrow.get('2017-03-26'), run_type
        )
...
class TestWW3OunpContents:
    ...
    def test_ww3_ounp_contents(self, run_type):
        contents = run_ww3._ww3_ounp_contents(
            arrow.get('2017-03-26'), run_type
        )
...
class TestLaunchRun:
    ...
    def test_run_exec_cmd(self, m_run, m_popen, run_type):
        ...
        run_exec_cmd = run_ww3._launch_run(
            run_type, Path('SoGWW3.sh'), 'west.cloud'
        )
