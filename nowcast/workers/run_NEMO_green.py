...
def run_NEMO_green(run_type):
    run_prep_dir = '/Users/sallen/Documents/MeoPar/nowcast-green/'
...
#    salishsea_cmd.api.run_in_subprocess(run_id, config, 'iodef.xml', results_dir)
...
def update_yaml_file(run_prep_dir, run_date, restart_timestep):
    ...
    yamlfile = os.path.join(run_prep_dir, 'SalishSea_nowcast_green_template.yaml')
    ...
    for f, s in zip ((restartfile, trcrestartfile), ('restart.nc', 'restart_trc.nc')):
